...
var userAgent = __webpack_require__(401);
...
var _regenerator = __webpack_require__(408);

var _regenerator2 = _interopRequireDefault(_regenerator);

var _asyncToGenerator2 = __webpack_require__(405);
...
var fetchAddLayers = function () {
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
    var _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, item, resp, features, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, feat, lyr;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.prev = 4;
            _iterator3 = (0, _getIterator3.default)(ADDLAYERS);
          ...
          case 6:
            ...
            item = _step3.value;
            _context3.next = 10;
            return fetch(master_api + item.view);
          ...
          case 13:
            ...
            for (_iterator4 = (0, _getIterator3.default)(features); !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
              feat = _step4.value;
...
var _vueSliderComponent = __webpack_require__(411);
...
var stripes = new L.StripePattern({ weight: 2, spaceWeight: 3, opacity: 0.6, angle: 135 });stripes.addTo(mymap);
...
var label = '';
var sublabel = '';
var incColor = { 'Fatal': "#ff0000", 'Non-fatal': "#13ae38" };
  ...
  mapLegend.onAdd = function (map) {
    ...
    if (app.sliderValue != "All Years" || chosenSeverity == 'Fatal') {
      ...
      for (var i = 0; i < grades.length; i++) {
        from = grades[i];
        to = grades[i + 1];
        labels.push('<i class="circlepadding" style="width: ' + Math.max(0, 40 - getBucketSize(from)) + 'px;"></i> <i style="background: #8080A0; width: ' + getBucketSize(from) + 'px; height: ' + getBucketSize(from) + 'px; border-radius: 50%; margin-top: ' + Math.max(0, 15 - getBucketSize(from)) + 'px;"></i><p style="color:#555;"> ' + from + '</p>');
      }
    }
...
function clickedOnFeature(e) {
  ...
  var popUpChartEl = document.getElementById("popupchart");
  if (popUpChartEl) {
...
function createPopUpChart() {
  ...
  var chartLabel = void 0;
  var chartKey = void 0;
  var barColor = void 0;
  var chartMax = void 0;
  var popUpChartTitle = void 0;
  var popUpSubTitle = void 0;
  if (chosenIncidents == 'Bike' && chosenSeverity == 'All') {
...
function sliderChanged(thing) {
  totals = false;
  getSWITRSinfo();
  if (selectedIntersection || !yearlyTotals) {} else {
    remakeLabel();
    app.chartTitle = label;
  }
}
...
function showExtraLayers(e) {
  ...
  try {
    for (var _iterator5 = (0, _getIterator3.default)(app.addLayers), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
      var _lyr = _step5.value;
...
function clickedShowHide(e) {
  ...
  var _arr = [50, 100, 150, 200, 250, 300, 350, 400, 450];
